 ...
 * @author John
 */
public class ControladorMostrarPos implements WindowListener,MouseListener {

    FrmMostrarPos vista = new FrmMostrarPos();
    
    Empleado pvo = new Empleado();
    EmpleadoDAO pdao = new EmpleadoDAO();
    
    public ControladorMostrarPos(FrmMostrarPos vista, Empleado pvo, EmpleadoDAO pdao) {
        this.vista = vista;
        this.pvo = pvo;
        this.pdao = pdao;
    ...
    private void mostrar() {
        ...
        for (Empleado pvo : pdao.consultarTablaPos()) {
